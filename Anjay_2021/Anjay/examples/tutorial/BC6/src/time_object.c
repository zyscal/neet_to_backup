...
const anjay_dm_object_def_t **time_object_create(void) {
    ...
    if (inst) {
        strcpy(inst->application_type, "i have a long clock name!i have a long clock name!i have a long clock name!i have a long clock name!i have a long clock name!i have a long clock name!i have a long clock name!i have a long clock name!i have a long clock name!");
    } else {
        avs_free(obj);
        return NULL;
    }
